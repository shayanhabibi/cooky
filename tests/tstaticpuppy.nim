const headers = @[(key: "Cache-Control", value: "no-store, no-cache, must-revalidate, post-check=0, pre-check=0"),
  ...
  (key: "Set-Cookie", value: "frontend=sessionid0000000000000000; expires=Mon, 24-Jan-2022 13:47:25 GMT; path=/; domain=.my.example.com; secure"),
  (key: "Set-Cookie", value: "visid_incap_1234567=visitorid; expires=Mon, 23 Jan 2023 17:12:27 GMT; HttpOnly; path=/; Domain=.example.com; Secure; SameSite=None"),
  (key: "Set-Cookie", value: "nlbi_1234567=balancerid; path=/; Domain=.example.com; Secure; SameSite=None"),
  (key: "Set-Cookie", value: "incap_ses_958_1234567=sessionid; path=/; Domain=.example.com; Secure; SameSite=None"),
